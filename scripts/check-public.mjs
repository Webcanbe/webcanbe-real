...
for(const href of footerUrls)check(href==='https://github.com/Webcanbe/webcanbe-real'||['/seller','/seller/projects/new'].includes(href)||Boolean(routes[href]),'Footer route '+href)
