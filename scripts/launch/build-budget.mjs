...
const checks = [
  ...
  ["total CSS", cssTotal <= limits.cssTotal, `${kib(cssTotal).toFixed(1)} KiB <= 510 KiB`],
  ["app CSS", appCssTotal <= limits.appCssTotal, `${kib(appCssTotal).toFixed(1)} KiB <= 190 KiB`],
