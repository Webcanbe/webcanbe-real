...
const aliases={'/marketplace':'/browse','/templates':'/browse','/pricing':'/plans','/terms':'/legal/terms','/privacy':'/legal/privacy','/policy':'/legal/privacy','/licenses':'/legal/licenses'}
const schema=(url,m)=>{
...
const privatePaths=['/__webcanbe/','/__wcb','/dashboard','/dashboard-preview','/workspace/','/projects','/purchases','/settings','/seller','/checkout/','/_ops/','/login','/signup','/auth/']
