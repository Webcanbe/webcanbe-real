...
const privatePaths=['/__webcanbe/','/__wcb','/dashboard','/dashboard-preview','/workspace','/projects','/purchases','/settings','/seller','/checkout/','/_ops/','/login','/signup','/auth/','/marketplace','/editor/','/app/','/profile','/account','/billing','/notifications','/help']
