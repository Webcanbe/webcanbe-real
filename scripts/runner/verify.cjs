...
(async()=>{
 ...
 console.log(JSON.stringify({result:'PASS',resourceProperties,frozenWorkerKilledAfterMs:elapsed,memoryExhaustionKilled:true,boundary:'Linux namespaces + systemd cgroup inside no-mount Lima VM',control,isolated,records,revokedGenerationDenied:true},null,2));
