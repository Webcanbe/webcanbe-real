...
export default defineConfig({
  ...
  plugins: [webCanBeFixturePlugin(process.cwd(), { runner: process.env.WCB_PREVIEW_PROVIDER === "lima" ? new LocalLimaRunnerProvider(process.cwd()) : undefined }), react(), tailwindcss()],
