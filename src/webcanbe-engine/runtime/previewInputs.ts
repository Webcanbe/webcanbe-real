...
export function validPreviewInput(input: unknown): input is PreviewInput {
  ...
  if (v.type === "key") return exact(["type", "key", "shift"]) && typeof v.shift === "boolean" && ["Tab", "Enter", "Escape", "Backspace", "Delete", "ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Home", "End", "PageUp", "PageDown", "SelectAll", "CopySelection"].includes(String(v.key))
