...
it('creates a persisted categorized case with bounded safe context and no secrets or query strings',async()=>{
 ...
 const d=w.document,form=d.querySelector('form');form.querySelector('[name=subject]').value='Preview issue';form.querySelector('[name=message]').value='The preview failed after opening my project.';form.querySelector('[name=steps]').value='Open the project and connect preview.';form.querySelector('[name=context]').checked=true
