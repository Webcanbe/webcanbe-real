-- Payment owner contract 51b28d89746466c5b4f231b5bee7bd4a935dced7.
-- Server-only access; no payment activation or provider calls.
BEGIN;
...
ALTER TABLE public.wcb_creator_terms ENABLE ROW LEVEL SECURITY;
CREATE POLICY wcb_creator_terms_server ON public.wcb_creator_terms TO webcanbe_runtime USING (true) WITH CHECK (true);
GRANT SELECT, INSERT, UPDATE ON public.wcb_creator_terms TO webcanbe_runtime;
ALTER TABLE public.wcb_orders ENABLE ROW LEVEL SECURITY;
CREATE POLICY wcb_orders_server ON public.wcb_orders TO webcanbe_runtime USING (true) WITH CHECK (true);
GRANT SELECT, INSERT, UPDATE ON public.wcb_orders TO webcanbe_runtime;
ALTER TABLE public.wcb_payment_identities ENABLE ROW LEVEL SECURITY;
CREATE POLICY wcb_payment_identities_server ON public.wcb_payment_identities TO webcanbe_runtime USING (true) WITH CHECK (true);
GRANT SELECT, INSERT, UPDATE ON public.wcb_payment_identities TO webcanbe_runtime;
ALTER TABLE public.wcb_provider_events ENABLE ROW LEVEL SECURITY;
CREATE POLICY wcb_provider_events_server ON public.wcb_provider_events TO webcanbe_runtime USING (true) WITH CHECK (true);
GRANT SELECT, INSERT, UPDATE ON public.wcb_provider_events TO webcanbe_runtime;
ALTER TABLE public.wcb_subscriptions ENABLE ROW LEVEL SECURITY;
CREATE POLICY wcb_subscriptions_server ON public.wcb_subscriptions TO webcanbe_runtime USING (true) WITH CHECK (true);
GRANT SELECT, INSERT, UPDATE ON public.wcb_subscriptions TO webcanbe_runtime;
ALTER TABLE public.wcb_subscription_payments ENABLE ROW LEVEL SECURITY;
CREATE POLICY wcb_subscription_payments_server ON public.wcb_subscription_payments TO webcanbe_runtime USING (true) WITH CHECK (true);
GRANT SELECT, INSERT, UPDATE ON public.wcb_subscription_payments TO webcanbe_runtime;
ALTER TABLE public.wcb_ai_pack_orders ENABLE ROW LEVEL SECURITY;
CREATE POLICY wcb_ai_pack_orders_server ON public.wcb_ai_pack_orders TO webcanbe_runtime USING (true) WITH CHECK (true);
GRANT SELECT, INSERT, UPDATE ON public.wcb_ai_pack_orders TO webcanbe_runtime;
ALTER TABLE public.wcb_ai_purchased_credits ENABLE ROW LEVEL SECURITY;
CREATE POLICY wcb_ai_purchased_credits_server ON public.wcb_ai_purchased_credits TO webcanbe_runtime USING (true) WITH CHECK (true);
GRANT SELECT, INSERT, UPDATE ON public.wcb_ai_purchased_credits TO webcanbe_runtime;
ALTER TABLE public.wcb_ai_included_grants ENABLE ROW LEVEL SECURITY;
CREATE POLICY wcb_ai_included_grants_server ON public.wcb_ai_included_grants TO webcanbe_runtime USING (true) WITH CHECK (true);
GRANT SELECT, INSERT, UPDATE ON public.wcb_ai_included_grants TO webcanbe_runtime;
ALTER TABLE public.wcb_refunds ENABLE ROW LEVEL SECURITY;
CREATE POLICY wcb_refunds_server ON public.wcb_refunds TO webcanbe_runtime USING (true) WITH CHECK (true);
GRANT SELECT, INSERT, UPDATE ON public.wcb_refunds TO webcanbe_runtime;
ALTER TABLE public.wcb_payout_batches ENABLE ROW LEVEL SECURITY;
CREATE POLICY wcb_payout_batches_server ON public.wcb_payout_batches TO webcanbe_runtime USING (true) WITH CHECK (true);
GRANT SELECT, INSERT, UPDATE ON public.wcb_payout_batches TO webcanbe_runtime;
ALTER TABLE public.wcb_creator_ledger ENABLE ROW LEVEL SECURITY;
CREATE POLICY wcb_creator_ledger_server ON public.wcb_creator_ledger TO webcanbe_runtime USING (true) WITH CHECK (true);
GRANT SELECT, INSERT, UPDATE ON public.wcb_creator_ledger TO webcanbe_runtime;
ALTER TABLE public.wcb_payment_reconciliation ENABLE ROW LEVEL SECURITY;
CREATE POLICY wcb_payment_reconciliation_server ON public.wcb_payment_reconciliation TO webcanbe_runtime USING (true) WITH CHECK (true);
GRANT SELECT, INSERT, UPDATE ON public.wcb_payment_reconciliation TO webcanbe_runtime;
COMMIT;
